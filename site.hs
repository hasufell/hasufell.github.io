...
feedConfig = FeedConfiguration
    { feedTitle       = "Hasufell's blog"
    , feedDescription = "Haskell and tech stuff, mostly"
    , feedAuthorName  = "Julian Ospald"
    , feedAuthorEmail = "hasufell@posteo.de"
    , feedRoot        = "https://github.com/hasufell/hasufell.github.io"
    }
...
siteCtx =
    baseCtx `mappend`
    constField "site_description" "Hasufell's blog" `mappend`
    constField "site-url" "https://github.com/hasufell/hasufell.github.io" `mappend`
    constField "tagline" "haskell and tech, mostly" `mappend`
    constField "site-title" "Hasufell's blog" `mappend`
    constField "copy-year" "2021" `mappend`
    constField "github-repo" "https://github.com/hasufell/hasufell.github.io" `mappend`
    defaultContext

baseCtx =
    constField "baseurl" "https://hasufell.github.io"
